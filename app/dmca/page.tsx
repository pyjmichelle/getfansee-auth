...
import { Mail, FileText, AlertCircle } from "@/lib/icons";
...
export default function DMCAPage() {
  return (
    <LegalPageShell
      ...
      subtitle={
        <>
          <p className="text-tiny mb-2">Last updated: {LEGAL_EFFECTIVE_DATE}</p>
          <p>
    ...
    >
      <div className="card-block p-8 prose prose-invert max-w-none space-y-8">
        {/* Quick Submit Card */}
        <Card className="card-block border-[var(--border-wine)]/20">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Mail className="w-5 h-5 text-wine-text" />
          ...
          <CardContent className="space-y-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-wine-text font-semibold text-lg hover:underline"
            >
              {DMCA_CONTACT_EMAIL}
            </a>
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 text-text-secondary space-y-3">
            <li>
              <strong className="text-wine-text">Identification of the copyrighted work</strong> - A
              description of the copyrighted work you claim has been infringed. If multiple works
              are covered, you may provide a representative list.
            </li>
            <li>
              <strong className="text-wine-text">Identification of the infringing material</strong>{" "}
              - The URL(s) or specific location of the content you claim is infringing, with enough
              detail for us to locate it.
            </li>
            <li>
              <strong className="text-wine-text">Your contact information</strong> - Your full legal
              name, mailing address, telephone number, and email address.
            </li>
            <li>
              <strong className="text-wine-text">Good faith statement</strong> - A statement that
              you have a good faith belief that the use of the material is not authorized by the
              copyright owner, its agent, or the law.
            </li>
            <li>
              <strong className="text-wine-text">Accuracy statement</strong> - A statement that the
              information in your notice is accurate, and under penalty of perjury, that you are
              authorized to act on behalf of the copyright owner.
            </li>
            <li>
              <strong className="text-wine-text">Electronic or physical signature</strong> - Your
        ...
        {/* Email Template */}
        <section>
          <h2 className="text-h2 mb-4">Email Template</h2>
...
Date: [Current date]`}
        ...
        <section>
          <h2 className="text-h2 mb-4">Counter-Notification</h2>
          <p className="text-text-secondary mb-4">
        ...
        <Card className="border-error/30 bg-error/5">
          ...
          <CardContent className="text-text-secondary space-y-3">
            <p>
              <strong className="text-wine-text">False claims:</strong> Filing a false DMCA notice
              or counter-notice is illegal. Under Section 512(f) of the DMCA, you may be liable for
              damages if you knowingly misrepresent material or activity as infringing.
            </p>
            <p>
              <strong className="text-wine-text">Repeat infringers:</strong> GetFanSee maintains a
              policy of terminating accounts of users who are found to be repeat infringers.
            </p>
          </CardContent>
        </Card>
        ...
        {/* Response Time */}
        <section>
          <h2 className="text-h2 mb-4">Response Time</h2>
          <p className="text-text-secondary">
        ...
        <section className="pt-8 border-t">
          <h2 className="text-h2 mb-4">DMCA Agent Contact</h2>
          <div className="text-text-secondary space-y-2">
            <p>
              <strong className="text-wine-text">Designated Agent:</strong> {LEGAL_COMPANY_NAME}
            </p>
            <p>
              <strong className="text-wine-text">Address:</strong> {LEGAL_REGISTERED_ADDRESS}
            </p>
            <p>
              <strong className="text-wine-text">Email:</strong> {DMCA_CONTACT_EMAIL}
            </p>
            <p>
              <strong className="text-wine-text">Subject Line:</strong> DMCA Takedown Request
            </p>
          </div>
