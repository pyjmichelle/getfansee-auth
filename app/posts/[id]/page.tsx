...
const PAGE_MOCK_POSTS: Record<string, { post: Post; canView: boolean }> = {
  "mock-post-1": {
    ...
    post: {
      ...
      visibility: "ppv",
      price_cents: 1500,
      media_urls: ["https://picsum.photos/seed/sophia-art1/800/1000"],
  ...
  "mock-post-locked": {
    ...
    post: {
      ...
      content: "Subscribe to unlock this exclusive content from Nadia Fashion.",
      creator_id: "mock-creator-9",
      visibility: "subscribers",
      price_cents: 0,
      media_urls: ["https://picsum.photos/seed/nadia-fashion1/800/1000"],
