    ...
    >
      <div className="prose prose-invert max-w-none space-y-6">
        ...
        <div className="card-block p-8 rounded-2xl">
          <h2 className="text-h2 mb-4">Statement of Compliance</h2>
          <p className="text-text-secondary">
            ...
            <strong>28 C.F.R. Part 75</strong>, which require producers of sexually explicit content
            to maintain age-verification records for all performers depicted therein.
          </p>
        </div>

        <div className="card-block p-8 rounded-2xl">
          <h2 className="text-h2 mb-4">Creator Verification Requirement</h2>
          <p className="text-text-secondary">
          ...
          <ul className="list-disc pl-6 text-text-secondary space-y-2 mt-3">
            ...
            <li>
              Warrant, represent, and certify that any performer depicted in content they upload was
              at least 18 years of age at the time the content was produced.
            </li>
            <li>
        ...
        <div className="card-block p-8 rounded-2xl">
          <h2 className="text-h2 mb-4">Custodian of Records</h2>
          <p className="text-text-secondary">
        ...
        <div className="card-block p-8 rounded-2xl">
          <h2 className="text-h2 mb-4">Platform Role</h2>
          <p className="text-text-secondary">
            ...
            direct any content. All content is created independently by creators who have agreed to
            our{" "}
        ...
        <div className="card-block p-8 rounded-2xl">
          <h2 className="text-h2 mb-4">Enforcement</h2>
          <p className="text-text-secondary">
            Content found to violate our age-verification policies is subject to immediate removal.
            Creators found to have uploaded content involving performers under the age of 18 will be
            permanently banned, and the matter will be reported to the National Center for Missing
            and Exploited Children (NCMEC) and relevant law enforcement agencies.
          </p>
        </div>

        <div className="card-block p-8 rounded-2xl">
          <h2 className="text-h2 mb-4">Exemption Notice</h2>
          <p className="text-text-secondary">
            Pursuant to 28 C.F.R. § 75.6, certain content may be exempt from the inspection
            requirements of this section. Any content that does not contain any visual depiction of
            actual sexually explicit conduct as defined in 18 U.S.C. § 2256(2)(A) is exempt from the
