...
export default function AboutPage() {
  return (
    <LegalPageShell title="About GetFanSee">
      <div className="prose prose-invert max-w-none space-y-6">
        <div className="card-block p-8 rounded-2xl">
          ...
          <p className="text-text-secondary">
            ...
            monetise their content directly and build closer connections with their fans. We provide
            a safe, transparent, and compliant environment for adult content creators and their
            subscribers.
          </p>
        </div>

        <div className="card-block p-8 rounded-2xl">
          <h2 className="text-h2 mb-4">Legal Entity</h2>
          <div className="bg-surface-raised p-6 rounded-xl space-y-3 text-text-secondary">
            ...
            <div className="flex flex-col sm:flex-row sm:gap-4">
              <span className="font-semibold text-text-primary min-w-[180px]">Effective Date</span>
          ...
          <p className="text-text-tertiary text-small mt-3">
        ...
        <div className="card-block p-8 rounded-2xl">
          <h2 className="text-h2 mb-4">Our Commitment to Safety</h2>
          ...
          <ul className="list-disc pl-6 text-text-secondary space-y-2">
            <li>
              ...
              confirm they are 18+ before accessing any content. Creators must complete a KYC (Know
              Your Customer) identity verification process before monetising content.
            </li>
            <li>
              <strong className="text-text-primary">Content Moderation:</strong> All uploaded
              content is subject to review. We have an active moderation team that reviews reported
              content and enforces our Content Guidelines.
            </li>
            <li>
              <strong className="text-text-primary">Fraud Controls:</strong> We employ automated
              financial auditing, transaction monitoring, and abuse detection systems to protect our
              users.
            </li>
            <li>
              <strong className="text-text-primary">Record Keeping:</strong> We maintain records in
            ...
            <li>
              <strong className="text-text-primary">DMCA Compliance:</strong> We respond promptly to
              valid copyright takedown notices. See our{" "}
        ...
        <div className="card-block p-8 rounded-2xl">
          <h2 className="text-h2 mb-4">Legal Documents</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <Link
                key={link.href}
                href={link.href}
                className="bg-surface-raised p-4 text-wine-text text-small font-medium hover:bg-surface-overlay transition-colors rounded-xl"
              >
                {link.label} →
              </Link>
            ))}
