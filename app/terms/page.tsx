      ...
      <div className="card-block p-8 prose prose-invert max-w-none space-y-8">
        ...
        <section>
          ...
          <p className="text-text-secondary">
            By accessing or using {PLATFORM_NAME}, operated by {LEGAL_COMPANY_NAME} ("we", "our", or
            "us"), you agree to be bound by these Terms of Service ("the Service"). If you do not
            agree to these terms, please do not use the Service.
          </p>
        </section>

        <section>
          <h2 className="text-h2 mb-4">2. Age Requirement</h2>
          <p className="text-text-secondary">
            You must be at least 18 years old to use the Service. By using the Service, you
            represent and warrant that you are at least 18 years of age. The Service contains adult
            content that may not be suitable for minors.
          </p>
        </section>
        ...
        <section>
          <h2 className="text-h2 mb-4">4. User Content</h2>
          <p className="text-text-secondary">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-text-secondary space-y-2">
            ...
            <li>
              Refunds for subscription charges may be issued at our discretion within 48 hours of a
              billing date in cases of technical error or duplicate charge.
            </li>
          </ul>

          <h3 className="text-h4 mt-4 mb-2">Pay-Per-View & Wallet Purchases</h3>
          <ul className="list-disc pl-6 text-text-secondary space-y-2">
            <li>
          ...
          <p className="text-text-secondary mt-4">
            ...
            suspension. We are committed to resolving disputes fairly and promptly.
          </p>
        </section>

        <section id="tips">
          <h2 className="text-h2 mb-4">6. Tips / Gratuities</h2>
          <p className="text-text-secondary">
            The Service lets fans send creators optional <strong>tips</strong> (also referred to as
            &quot;buy me a coffee&quot;, gratuities, or support). The following terms apply to every
            tip:
          </p>
          <ul className="list-disc pl-6 text-text-secondary space-y-2 mt-3">
            ...
            <li>
              ...
              prohibited from offering, promising, or implying anything in exchange for a tip. Paid
              deliverables must be sold through subscriptions or pay-per-view, not tips.
            </li>
            <li>
              ...
              expectation, understanding, or private arrangement between a fan and a creator. We are
              not liable for a creator&apos;s failure to provide anything a fan may have hoped to
              receive.
            </li>
            <li>
            ...
            <li>
              <strong className="text-text-primary">Service fee.</strong> {PLATFORM_NAME} retains a
              platform service fee from each tip; the remaining net amount is credited to the
        ...
        <section>
          <h2 className="text-h2 mb-4">7. Creator Payouts</h2>
          <p className="text-text-secondary">
            Creators receive payouts subject to platform fees and minimum thresholds. GetFanSee
            reserves the right to withhold payments pending investigation of policy violations. See
            our Beta Payout Policy for current terms.
          </p>
        </section>

        <section id="prohibited-content">
          <h2 className="text-h2 mb-4">8. Prohibited Content & Acceptable Use</h2>
          <p className="text-text-secondary mb-4">
            GetFanSee is committed to providing a safe and legal platform. The following content and
            activities are strictly prohibited. Violations may result in immediate account
            termination, content removal, and referral to law enforcement authorities.
          </p>

          <h3 className="text-h4 mt-4 mb-2">Absolutely Prohibited (Zero Tolerance)</h3>
          <ul className="list-disc pl-6 text-text-secondary space-y-2">
            <li>
              <strong className="text-text-primary">Content involving minors</strong> — any content
              that sexually exploits, depicts, or endangers individuals under 18 years of age. We
              report all such content to the National Center for Missing &amp; Exploited Children
              (NCMEC) and relevant law enforcement.
            </li>
            <li>
          ...
          <h3 className="text-h4 mt-4 mb-2">Also Prohibited</h3>
          <ul className="list-disc pl-6 text-text-secondary space-y-2">
            <li>
          ...
          <h3 className="text-h4 mt-4 mb-2">Creator Responsibilities</h3>
          <p className="text-text-secondary">
        ...
        <section>
          <h2 className="text-h2 mb-4">10. Termination</h2>
          <p className="text-text-secondary">
          ...
          <ul className="list-disc pl-6 text-text-secondary space-y-2">
            ...
            <li>Unused wallet balance refund eligibility will be assessed per our Refund Policy</li>
          </ul>
        </section>

        <section>
          <h2 className="text-h2 mb-4">10a. External Links & Beta Program</h2>
          <p className="text-text-secondary">
            Creator profiles may display links to third-party platforms after admin review.
            {PLATFORM_NAME} does not operate or endorse external sites; purchases and interactions
            on them are governed solely by those platforms&apos; terms, and {PLATFORM_NAME} cannot
            process refunds or resolve disputes for them. During the Alpha/Beta phases, additional
            program-specific terms (Founding Creator commission, referral rewards, promotional
            credits, cryptocurrency payments) are set out in the{" "}
            <Link href="/beta-terms" className="text-wine-text underline hover:no-underline">
              Beta Program Terms
            </Link>{" "}
            and{" "}
            <Link href="/creator-rules" className="text-wine-text underline hover:no-underline">
              Creator Rules
            </Link>
            .
          </p>
        ...
        <section>
          <h2 className="text-h2 mb-4">11. Disclaimer of Warranties</h2>
          <p className="text-text-secondary">
        ...
        <section>
          <h2 className="text-h2 mb-4">12. Limitation of Liability</h2>
          <p className="text-text-secondary">
        ...
        <section>
          <h2 className="text-h2 mb-4">13. Changes to Terms</h2>
          <p className="text-text-secondary">
        ...
        <section>
          <h2 className="text-h2 mb-4">14. Governing Law and Dispute Resolution</h2>
          <p className="text-text-secondary">
          ...
          <p className="text-text-secondary mt-4">
            ...
            arising out of or relating to these Terms or the Services. You and {PLATFORM_NAME} each
        ...
        <section>
          <h2 className="text-h2 mb-4">15. Contact</h2>
