  ...
  return (
    <AuthShell>
      <div className="text-center">
        {status === "loading" && (
          <>
            <div className="w-20 h-20 rounded-full bg-[var(--wine)] flex items-center justify-center mx-auto mb-6 animate-pulse">
              <Loader2 className="w-10 h-10 text-text-primary animate-spin" />
            </div>
            <h1 className="text-h1 text-text-primary mb-3">Verifying...</h1>
        ...
        {status === "success" && (
          <>
            <div className="w-20 h-20 rounded-full bg-[var(--success)]/20 flex items-center justify-center mx-auto mb-6 ring-4 ring-[var(--success)]/30">
              <CheckCircle2 className="w-10 h-10 text-[var(--success)]" />
            </div>
            <h1 className="text-h1 text-text-primary mb-3">Verification Successful!</h1>
        ...
        {status === "error" && (
          <>
            <div className="w-20 h-20 rounded-full bg-[var(--error)]/15 flex items-center justify-center mx-auto mb-6 ring-4 ring-[var(--error)]/25">
              <XCircle className="w-10 h-10 text-[var(--error-text)]" />
            </div>
            <h1 className="text-h1 text-text-primary mb-3">Verification Failed</h1>
            <p className="text-text-secondary mb-6">{message}</p>
