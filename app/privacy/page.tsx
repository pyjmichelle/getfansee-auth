    ...
    <LegalPageShell title="Privacy Policy">
      <div className="card-block p-8 prose prose-invert max-w-none space-y-8">
        ...
        <section>
          ...
          <h3 className="text-h3 mb-3 mt-6">2.1 Information You Provide</h3>
          ...
          <h3 className="text-h3 mb-3 mt-6">2.2 Information Collected Automatically</h3>
          <ul className="list-disc pl-6 text-text-secondary space-y-2">
        ...
        <section>
          <h2 className="text-h2 mb-4">3a. Newsletter & Marketing Emails</h2>
          <p className="text-text-secondary">
            If you sign up for creator updates or our newsletter, we store your email address and
            only send marketing emails after you confirm your subscription via the link we send
            (double opt-in). Every marketing email contains an unsubscribe link, and you can
            withdraw consent at any time — this does not affect transactional emails (receipts,
            security notices). We do not share newsletter lists with third parties except the email
            delivery provider acting on our behalf.
          </p>
        </section>

        <section>
          <h2 className="text-h2 mb-4">4. Information Sharing</h2>
        ...
        <section>
          <h2 className="text-h2 mb-4">6. Data Retention</h2>
          <p className="text-text-secondary">
        ...
        <section>
          <h2 className="text-h2 mb-4">7. Your Rights</h2>
          <p className="text-text-secondary">
        ...
        <section>
          ...
          <h3 className="text-h3 mb-3 mt-6">Legal Bases for Processing</h3>
          ...
          <ul className="list-disc pl-6 text-text-secondary space-y-2">
            ...
            <li>
              ...
              applicable laws including 18 U.S.C. § 2257 and financial record-keeping (Art. 6(1)(c)
              GDPR)
            </li>
            <li>
          ...
          <h3 className="text-h3 mb-3 mt-6">Your GDPR Rights</h3>
          <ul className="list-disc pl-6 text-text-secondary space-y-2">
          ...
          <h3 className="text-h3 mb-3 mt-6">Right to Lodge a Supervisory Authority Complaint</h3>
          <p className="text-text-secondary">
            You have the right to lodge a complaint with your local data protection authority (e.g.,
            the ICO in the UK, or the relevant national DPA in your EEA country) if you believe we
            have not handled your data appropriately.
          </p>

          <h3 className="text-h3 mb-3 mt-6">Data Protection Contact</h3>
          <p className="text-text-secondary">
          ...
          <h3 className="text-h3 mb-3 mt-6">International Data Transfers</h3>
          <p className="text-text-secondary">
            Where we transfer personal data outside the EEA or UK, we ensure appropriate safeguards
            are in place, such as Standard Contractual Clauses (SCCs) approved by the European
            Commission, or transfers to countries with an adequacy decision.
          </p>
        </section>
        ...
        <section>
          ...
          <h3 className="text-h3 mb-3 mt-6">Your CCPA Rights</h3>
          <ul className="list-disc pl-6 text-text-secondary space-y-2">
            <li>
            ...
            <li>
              ...
              we do <em>not</em> sell your personal information to third parties and do not share it
          ...
          <h3 className="text-h3 mb-3 mt-6">Do Not Sell or Share My Personal Information</h3>
          <p className="text-text-secondary">
            GetFanSee does <strong className="text-text-primary">not</strong> sell, rent, or share
            personal information with third parties for monetary consideration or for cross-context
            behavioural advertising. To submit any privacy request, contact us at{" "}
            <a
              href={`mailto:${PRIVACY_CONTACT_EMAIL}`}
              className="text-wine-text underline hover:no-underline"
            >
          ...
          <h3 className="text-h3 mb-3 mt-6">Submitting a CCPA Request</h3>
          <p className="text-text-secondary">
        ...
        <section>
          <h2 className="text-h2 mb-4">8. Cookies</h2>
        ...
        <section>
          ...
          <p className="text-text-secondary">
            ...
            collect information from minors. If we learn we have collected information from a minor,
            we will delete that information immediately.
          </p>
        </section>

        <section>
          <h2 className="text-h2 mb-4">10. International Transfers</h2>
          <p className="text-text-secondary">
        ...
        <section>
          <h2 className="text-h2 mb-4">11. Changes to This Policy</h2>
          <p className="text-text-secondary">
        ...
        <section>
          <h2 className="text-h2 mb-4">12. Contact Us</h2>
          <p className="text-text-secondary">
