...
- ✅ `components/bottom-navigation.tsx` - 移动端底部导航栏
  - 仅在移动端显示（`md:hidden`）
  - 支持活动状态高亮
  - 支持通知徽章
  - 键盘导航支持
...
- ✅ 添加 `safe-area-inset-bottom` CSS 类支持设备安全区域
...
- ✅ 所有动画支持 `motion-safe:` 和 `motion-reduce:`
...
- ✅ "Coming soon..." → "Coming soon" 或更友好的描述
- ✅ 所有加载文本使用正确的省略号
